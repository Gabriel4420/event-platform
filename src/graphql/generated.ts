...
export type GetQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string }> };
 ...
 * });
 */
export function useGetQuery(baseOptions?: Apollo.QueryHookOptions<GetQuery, GetQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetQuery, GetQueryVariables>(GetDocument, options);
      }
export function useGetLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetQuery, GetQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetQuery, GetQueryVariables>(GetDocument, options);
        }
...
export type GetQueryResult = Apollo.QueryResult<GetQuery, GetQueryVariables>;